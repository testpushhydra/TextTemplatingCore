...
namespace TemplateExecute
{
    public class TextTemplatingEngineHost : ITextTemplatingEngineHost
    {
        ...
        public LibraryLoadContext LoadContext { get; } = new LibraryLoadContext();
        ...
        public void Process(string[] args)
        {
            ...
            libraries = args.Length > 3 ? UnescapeArgs(args.Skip(3).ToArray()) : new string[0];
            ...
            using (Engine engine = new Engine())
            {
                ...
                string contents = engine.ProcessTemplate(content, this);
