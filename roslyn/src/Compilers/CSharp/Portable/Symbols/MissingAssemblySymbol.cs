...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal class MissingAssemblySymbol : AssemblySymbol
    {
        ...
        public MissingAssemblySymbol(AssemblyIdentity identity) : this(identity, null, null)
        {
        }

        public MissingAssemblySymbol(AssemblyIdentity identity, MetadataReferenceResolver? metadataReferenceResolver, CSharpCompilation.ReferenceManager referenceManager)
        {
