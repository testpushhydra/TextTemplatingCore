        ...
        internal NamedTypeSymbol GetWellKnownType(WellKnownType type)
        {
            ...
            if (_lazyWellKnownTypes == null || _lazyWellKnownTypes[index] is null)
            {
                ...
                else
                {
                    ...
                    result = this.Assembly.GetTypeByMetadataName(mdName, _options.MetadataReferenceResolver, includeReferences: true, useCLSCompliantNameArityEncoding: true, isWellKnownType: true, conflicts: out conflicts, warnings: legacyWarnings, ignoreCorLibraryDuplicatedTypes: ignoreCorLibraryDuplicatedTypes);
