...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    internal abstract class AssemblySymbol : Symbol, IAssemblySymbolInternal
    {
        ...
        public CSharpCompilation.ReferenceManager ReferenceManager { get; protected set; }
...
#nullable enable
        ...
        internal NamedTypeSymbol? GetTypeByMetadataName(string metadataName, MetadataReferenceResolver? metadataReferenceResolver, bool includeReferences, bool isWellKnownType, out (AssemblySymbol, AssemblySymbol) conflicts, bool useCLSCompliantNameArityEncoding = false, DiagnosticBag? warnings = null, bool ignoreCorLibraryDuplicatedTypes = false)
        {
            (AssemblySymbol, AssemblySymbol) thisConflicts;

            this.MetadataReferenceResolver = metadataReferenceResolver;

            var symbol = this.GetTypeByMetadataName(metadataName, includeReferences, isWellKnownType, out thisConflicts, useCLSCompliantNameArityEncoding, warnings, ignoreCorLibraryDuplicatedTypes);

            conflicts = thisConflicts;
